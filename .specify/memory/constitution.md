...
- **Frontend**: Next.js (App Router) + TypeScript + React + shadcn/ui + Tailwind CSS v4. All UI code MUST be TypeScript. Use server components by default, `'use client'` only when hooks/interactivity required.
...
| UI library | React + shadcn/ui | With Tailwind CSS v4 |
...
- **Frontend dev**: `cd next-frontend && npm run dev`
